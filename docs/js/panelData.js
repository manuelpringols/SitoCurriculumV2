...
export const PANEL_DATA = {
  ...
  devops: { tabs: [
    { label: 'Marmitta', items: [
      ...
      { title: 'Pitonzi (-py)',
        body: `🐍 Pitonzi — l'equivalente Python\n\n${"`"}marmitta -py${"`"} apre Pitonzi: stessa filosofia di Marmitta, ma per script Python.\n\n⚡ Venv in RAM\nLe dipendenze vengono installate in /dev/shm con pip --target — nessun virtual environment permanente, nessun inquinamento del sistema. Tutto viene pulito automaticamente all'uscita.\n\n🔍 Risoluzione dipendenze automatica\nAnalisi AST dello script prima dell'esecuzione: individua le import, installa solo quello che serve, senza richiedere un requirements.txt.\n\n💾 Salvataggio opzionale\nCon un tasto puoi salvare lo script e il venv in locale — hai subito un ambiente funzionante pronto per lo sviluppo.\n\nStessa navigazione fzf a 3 livelli, stessa integrazione con le sorgenti Marmitta.` },
    ]},
